...
npm run build-android-bundle --uglify --snapshot -- --release --key-store-path ./keystore.jks --key-store-password password --key-store-alias test --key-store-alias-password password
